        ...
        <div className="glass-card rounded-2xl p-8">
          ...
          <div className="mt-6 relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#1E293B] px-3 text-slate-500">or sign up with</span>
            </div>
          </div>
          ...
          <p className="text-xs text-slate-600 text-center mt-6">
            By signing up, you agree to our <a href="#" className="text-slate-400 hover:text-white">Terms of Service</a> and <a href="#" className="text-slate-400 hover:text-white">Privacy Policy</a>.
          </p>
        </div>
