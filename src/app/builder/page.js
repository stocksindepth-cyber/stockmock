  ...
  return (
    <div className="min-h-screen bg-[#080C16]">
      <UpgradeBanner
        ...
        message="Save strategies to your portfolio is a Pro feature. Unlock Pro free (via Dhan) to save unlimited strategies, run full backtests, and access 8+ years of NSE data."
      />
