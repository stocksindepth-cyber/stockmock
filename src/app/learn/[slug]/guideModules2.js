    ...
    sections: [
      {
         ...
         content: `
           ...
           <div class="bg-gradient-to-br from-indigo-900/20 to-black border border-indigo-500/20 p-8 rounded-2xl mb-8">
             ...
             <p class="text-slate-300 mb-4 leading-relaxed">In the Indian market, algorithmic sellers deploy massive Short Strangles on Tuesday (Expiry) morning at 9:30 AM. They sell 1-Delta OTM options on both wings. By 11:30 AM, if the market has merely oscillated by a few points, rapid Theta decay (Theta Waterfall) instantly wipes out those option premiums, allowing sellers to capture large yields in a span of 3 hours.</p>
